    ...
    <div className="sticky inset-x-0 top-0 z-30 w-full transition-all border-b border-gray-200 bg-white/75 backdrop-blur-lg">
      <div className="max-w-7xl mx-auto lg:px-8 px-6">
        <div className="relative flex h-14 items-center justify-between">
          ...
          >
            <img
              src="https://em-content.zobj.net/source/apple/391/money-with-wings_1f4b8.png"
          ...
          {/* placeholder */}
          <div className="hidden sm:block invisible">PolicyAnalyzer</div>
          ...
          >
            View on GitHub <Heart className="h-4 w-4 ml-1.5 fill-primary" />
          </Link>
        </div>
      </div>
    </div>
